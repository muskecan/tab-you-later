...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  saveBtn.addEventListener("click", async () => {
    ...
    const sResp = await chrome.runtime.sendMessage({ action: "getSettings" });
    ...
    await chrome.runtime.sendMessage({ action: "createCategory", name, color: selectedColor, saveCurrentTab });
    window.close();
  });
